...
<body>
	...
	<div class="main-content-wrapper d-flex clearfix">
		...
		<!-- Logo -->
		<div class="logo">
			<a href="/home1"> <img  class="img-responsive"  src="data:image/jpg;base64, <%=b64%>"  /></a>
				<%
		} catch (IOException e) {
		...
		<li>
			...
			<ul>
		<li> <h3>Welcome ${customer.customerName } </h3></li>
			<li class="active"><a href="/home1">Home</a></li>
			<li><a href="/viewProfile">View Profile</a></li>
			<li><a href="/updateProfile">Update Profile</a></li>
			<li><a href="/changePassword">Change Password</a>
			<li><a href="/cart">Cart</a></li>
			<li><a href="/deliveryAddress">Checkout</a></li>
		</ul>
		</nav> <!-- Button Group -->
		<div class="amado-btn-group mt-30 mb-100">
			<a href="#" class="btn amado-btn mb-15">%Discount%</a> 
			<a href="#" class="btn amado-btn active">New this week</a> <br> 
